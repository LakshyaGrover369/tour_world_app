...
const TourDetails = () => {
  ...
  //this is tatic later we fetch api and call from db
  const tour = tourData.find(tour=> tour.id === id)

  ////destructures the property from tour obeject 
            ...
            <div className="tour__info">
              ...
              <p>{desc}</p>
                  ...
                  <div className="tour__reviews mt-4">
                    ...
                    <ListGroup>
                      {reviews?.map(review => (
                        <div className="review__item mt-3">
                          <img src={avatar} alt="" />
                          <div className="w-100">
                            <div className="d-flex align-items-center justify-content-between">
                              ...
                              <span className='d-flex alignms-center'>
                               5 <i class="ri-star-s-fill"></i>
                              </span>
                            </div>
                              <h6>Amazing Tour</h6>
